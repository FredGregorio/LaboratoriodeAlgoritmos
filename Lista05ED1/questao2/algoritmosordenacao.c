...
void mergeSortChar(char *vetor, int tamanho){
    int meio, i, j, k;
    if (tamanho > 1) {
        meio = tamanho / 2;
        char esquerda[meio];
        char direita[tamanho - meio];
        ...
        mergeSortChar(esquerda, meio);
        mergeSortChar(direita, tamanho - meio);
...
void quickSortChar(char *vetor, int tamanho){
    if (tamanho > 1) {
        char pivo = vetor[tamanho - 1];
        int i = -1;
        char aux;
        ...
        quickSortChar(vetor, i + 1);
        quickSortChar(vetor + i + 2, tamanho - i - 2);
    }
}
